        ...
        <div className='grid grid-cols-8'>
            <div className='col-span-1 space-y-28 shadow-lg h-screen'>
                ...
                <div className='flex flex-col gap-5'>
                    <Link to="/admin" className={`${location.pathname == '/admin' && 'text-success bg-success/10 '} py-5 flex gap-2 items-center justify-between px-5 cursor-pointer group`}>
                        <label className={`text-xl font-semibold cursor-pointer group-hover:text-success duration-200`}>Service</label>
                    ...
                    <Link to="/admin/setting" className={`${location.pathname == '/admin/setting' && 'text-success bg-success/10'}  py-5 flex gap-2 items-center justify-between px-5 cursor-pointer group`}>
                        <label className={`text-xl font-semibold cursor-pointer group-hover:text-success duration-200`}>Setting</label>
