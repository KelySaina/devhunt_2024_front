        ...
        <div>
            <div className="grid grid-cols-2 h-screen">
                ...
                <div onMouseEnter={handleHoverRegister} className="flex flex-col items-center justify-center bg-success space-y-7 relative">
                    <h1 className="text-5xl text-white font-bold">N'as pas encore de compte?</h1>
                    <div className="space-y-1 text-white flex justify-center">
                        <p className="w-2/3 text-center text-2xl">
                            Découvrez tous vos services publics! Connectez-vous dès maintenant pour simplifier vos démarches et gagner du temps
                        </p>
                    </div>
                    <div>
                        <Link to={"/register"} className="btn rounded-full text-success hover:scale-110 hover:bg-white">Créer compte</Link>
